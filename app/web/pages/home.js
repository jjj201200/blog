    ...
    render() {
        ...
        return (
            <HomeWrapper className={this.mobStatus ? 'fix' : null}>
                ...
                <Sidebar></Sidebar>
                <Model
                    visible={!hasLogin && this.mobStatus === 'signUp'}
                    onCancel={this.closeMob}
                >

                </Model>
                {/*<SignUpMob show={!hasLogin && this.mobStatus === 'signUp'}*/}
                           {/*onClose={this.closeMob}/>*/}
                <LoginMob show={!hasLogin && this.mobStatus === 'login'}
                          onClose={this.closeMob}/>
                <WriteMob renderType={this.props.renderType} show={hasLogin && this.mobStatus === 'write'}
                          onClose={this.closeMob}/>
            </HomeWrapper>
        );
    }
